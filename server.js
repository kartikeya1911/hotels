const express = require('express');// calls express module web framework
const path = require('path');// importing path module to work with file and directory paths
const bodyParser = require('body-parser');// Converts HTTP requests into usable data for making it readable for Express (Express can't read requests by default)
const session = require('express-session');// express-session is a middleware for managing user sessions in Express applications
const connectDB = require('./src/config/database');// Connect to MongoDB
const User = require('./src/models/user');
const Booking = require('./src/models/booking');
const Contact = require('./src/models/Contact');
const MongoStore = require('connect-mongo');// MongoStore connects with mongodb session and logs in directly(prevents auto log out)
const helmet = require('helmet');// helmet is a middleware for securing Express apps by setting various HTTP headers
const morgan = require('morgan');// morgan is a logging library for Node.js
